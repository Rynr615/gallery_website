            ...
            <div class="m-5 flex justify-between">
                <form action="search.php" method="GET">
                    ...
                    <div class="mt-1 relative flex gap-2 rounded-md shadow-sm">
                        <input type="text" name="search" id="search" class="focus:ring-indigo-500 w-80 focus:border-indigo-500 block pr-10 sm:text-sm border-gray-300 rounded-md" placeholder="Search by username or email...">
