...
<body class="h-screen font-poppins">
                ...
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div class="flex flex-shrink-0 items-center">
                            ...
                            <a href="./profile" class="block sm:hidden text-gray-400 hover:text-white"><i class="fa-regular fa-user"></i> <?= $username ?> Profile</a>
                        </div>
    ...
    <div class="container mx-auto p-10">
        <div class="relative flex flex-col w-full h-80 sm:h-64 min-w-0 mb-6 !important break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 draggable">
            <!-- card body -->
            <div class="px-6 pt-6 sm:px-9 sm:pt-9 flex-auto min-h-[70px] pb-0 bg-transparent">
