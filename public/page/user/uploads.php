                ...
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div class="flex flex-shrink-0 items-center">
                            ...
                            <a href="./uploads.php" class="text-gray-400 hover:text-white"><i class="fa-solid fa-upload"></i> Uploads</a>
                        </div>
            ...
            <form action="" method="post" enctype="multipart/form-data" class="mx-auto w-full sm:w-1/3">
                <div class="flex flex-col gap-5">
                    ...
                    <div class="mt-6 flex items-center justify-center gap-x-6">
                        <button type="submit" class="rounded-md bg-indigo-600 px-10 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Uploads</button>
                    </div>
            </form>
        </div>
    </div>
