...
$query = "SELECT albums.albumID, albums.title, albums.description, albums.thumbnail_album, albums.createdAt, users.username AS uploader 
    FROM albums
    LEFT JOIN users ON albums.userID = users.userID WHERE albums.acces_level = 'public' OR albums.userID = '$userID'
                ...
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div class="flex flex-shrink-0 items-center">
                            <img class="hidden sm:block h-8 w-auto" src="../../assets/logo/logo-secondary.svg" alt="Numérique Gallery">
                            <a href="./dashboard.php" class="text-gray-400 block sm:hidden hover:text-white"><i class="fa-solid fa-house"></i> Dashboard</a>
                        </div>
